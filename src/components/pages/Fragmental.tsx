        ...
        <div className="project-modal__modal">
            ...
            <DialogContent>
                <div className="project-modal__modal__content">
                    <a className="project-modal__modal__image" href="https://tiago-silva.itch.io/fragmental">
                    ...
                    <span className="project-modal__modal__text">
                        ...
                        and the character-swapping mechanic.
                        For that mechanic, whenever 2 pieces of the same robot collide,
